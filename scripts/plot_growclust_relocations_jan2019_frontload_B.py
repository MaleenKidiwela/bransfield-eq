...
GROW_CSV = REPO / "catalogs" / "growclust_jan2019_frontload_B.csv"
ST = REPO / "catalogs" / "station_geometry.csv"
BATHY = REPO / "notes" / "figures" / "Orca_bathymetry.nc"
OUT = REPO / "notes" / "figures" / "growclust_relocations_jan2019_frontload_B.png"
...
fig.suptitle(f"GrowClust relocations — Jan 1 → Jan 30, 2019 (front-load run B)\n"
