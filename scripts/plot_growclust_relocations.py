"""Plot GrowClust relocations: pyocto (gridded) vs GrowClust (unlocked) on Orca."""
...
GROW_CSV = REPO / "catalogs" / "growclust_partial30days.csv"
ST = REPO / "catalogs" / "station_geometry.csv"
BATHY = REPO / "notes" / "figures" / "Orca_bathymetry.nc"
OUT = REPO / "notes" / "figures" / "growclust_relocations.png"
...
# (b) GrowClust relocated (continuous)
...
# (c) depth cross-section along longitude
...
fig.suptitle(f"GrowClust relocations on the 30-day partial catalog\n"
