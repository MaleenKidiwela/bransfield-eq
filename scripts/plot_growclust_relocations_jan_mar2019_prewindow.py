"""Plot the Jan 1 - Mar 15 2019 GrowClust relocations (pre-windowed run).
...
GROW_CSV = REPO / "catalogs" / "growclust_jan_mar2019_prewindow.csv"
ST = REPO / "catalogs" / "station_geometry.csv"
BATHY = REPO / "notes" / "figures" / "Orca_bathymetry.nc"
OUT = REPO / "notes" / "figures" / "growclust_relocations_jan_mar2019_prewindow.png"
...
fig.suptitle(f"GrowClust relocations — Jan 1 → Mar 15, 2019 (pre-windowed run)\n"
