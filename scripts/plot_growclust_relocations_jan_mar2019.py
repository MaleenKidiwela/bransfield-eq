...
GROW_CSV = REPO / "catalogs" / "growclust_jan_mar2019.csv"
ST = REPO / "catalogs" / "station_geometry.csv"
BATHY = REPO / "notes" / "figures" / "Orca_bathymetry.nc"
OUT = REPO / "notes" / "figures" / "growclust_relocations_jan_mar2019.png"
...
fig.suptitle(f"GrowClust relocations — Jan 1 → Mar 15, 2019 (front-loaded run)\n"
