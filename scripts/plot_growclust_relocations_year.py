...
GROW_CSV = REPO / "catalogs" / "growclust_picker_only.csv"
ST = REPO / "catalogs" / "station_geometry.csv"
BATHY = REPO / "notes" / "figures" / "Orca_bathymetry.nc"
OUT = REPO / "notes" / "figures" / "growclust_relocations_year.png"
...
fig.suptitle(f"GrowClust relocations on the full-year catalog\n"
